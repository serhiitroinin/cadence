...
- They are stored in the **macOS Keychain** (service `cadence`), never written to disk in
  plaintext. Non-secret config lives in `~/.config/cadence/` with `0600` permissions.
